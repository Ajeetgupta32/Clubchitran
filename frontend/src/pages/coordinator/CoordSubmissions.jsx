    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-[#E8E2D5] shadow-xs">
        <div>
          ...
          <p className="text-xs sm:text-sm text-stone-500 mt-1.5 flex flex-wrap items-center gap-1.5">
            <span>Branch Scope:</span>
            <span className="font-bold text-stone-800 bg-[#F5F0E8] px-2.5 py-0.5 rounded-lg border border-[#E8E2D5]">
            ...
            <span className="text-stone-400">• Verify student photos to confirm attendance (+100 pts)</span>
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-3xl border border-[#E8E2D5] shadow-xs flex flex-col md:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto">
          ...
          <select
            ...
            className="text-xs px-3 py-2 rounded-xl border border-[#E8E2D5] outline-none focus:ring-2 focus:ring-amber-700 bg-[#FDFCFB] text-stone-900 max-w-xs truncate"
          >
...
export default CoordSubmissions;
